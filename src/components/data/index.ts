...
export const Products:IProduct [] = [
    {
      ...
      description: "Chemise décontractée en lin pour homme.",
    ...
    },
    {
      ...
      description: "Montre-bracelet élégante avec bracelet en cuir.",
    ...
    },
    {
      ...
      description: "Casque audio sans fil avec une qualité sonore exceptionnelle.",
    ...
    },
    {
      ...
      description: "Sac à main en cuir véritable pour femme.",
    ...
    },
    {
      ...
      description: "Tasse à café en céramique avec un design unique.",
    ...
    },
    {
      ...
      description: "Ordinateur portable puissant avec un écran tactile.",
    ...
    },
    {
      ...
      description: "Ensemble de pinceaux de maquillage professionnels.",
    ...
    },
    {
      ...
      description: "Enceinte Bluetooth portable pour écouter de la musique où que vous soyez.",
